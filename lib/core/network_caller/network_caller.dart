    ...
    try {
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        return NetworkResponse(
          ...
          isSuccess: true,
          responsesData: jsonDecode(response.body),
        );
      } else if (response.statusCode == 401) {
        return NetworkResponse(
          statusCode: response.statusCode,
          isSuccess: false,
          errorSms: "Unauthorize user",
        );
      } else {
        return NetworkResponse(
          statusCode: response.statusCode,
          isSuccess: false,
          errorSms: "Something wrong",
        );
      }
    } catch (e) {
      return NetworkResponse(
    ...
    try {
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        return NetworkResponse(
          statusCode: response.statusCode,
          isSuccess: true,
          responsesData: response.body.isNotEmpty
        ...
        return NetworkResponse(
          statusCode: response.statusCode,
          isSuccess: false,
          errorSms: "error ${response.statusCode}",
        );
      }
    } catch (e) {
      return NetworkResponse(
